...
class DefaultAccount(AccountDB, metaclass=TypeclassBase):
    ...
    * Hook methods
    ...
    def create(cls, *args, **kwargs):
        ...
        if not guest:
            errors.append('Registrations are currently disabled. Please check back later.')
            return None, errors
        ...
        try:
            ...
            if account and settings.MULTISESSION_MODE < 2:
                ...
                location_map = defaultdict(lambda: "#2")
                zone = kwargs.get("zone", "")

                # TODO: load config from a file somehow...
                location_map['ABCD'] = '#1215'
                location_map['N766'] = '#1133'
                location_map['5F6Z'] = '#1039'
                location_map['R28B'] = '#1117'
                location_map['8F66'] = '#1168'
                location_map['X43K'] = '#1149'
                location_map['SB88'] = '#1012'
                location_map['B78H'] = '#1098'
                location_map['9Q4F'] = '#1182'

                # start_location = ObjectDB.objects.get_id(location_map[zone])
                start_location = ObjectDB.objects.get_id(location_map[zone])
